                            ...
                            <div class="card">
                                <div class="card-body card-block">
                                    <form action="{{ route('usuario.update') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="id" id="id" value="{{ Crypt::encrypt($usuario->id) }}">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" size="8" name="cep" id="cep"
                                                        value="{{ $usuario->cep }}" placeholder="CEP"
                                                        class="form-control">
                                                    @if ($errors->has('cep'))
                                                        <div class="div-invalid-feedback ">
                                                            {{ $errors->first('cep') }}
                                            ...
                                            <div class="col-md-7 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cidade" id="cidade" placeholder="Rua/Av."
                                                        value="{{ $usuario->cidade }}" class="form-control">
                                            ...
                                            <div class="col-md-2 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" size="2" readonly name="estado" id="estado"
                                                        placeholder="UF" value="{{ $usuario->estado }}"
                                                        class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rua" size="40" id="rua" placeholder="Rua/Av."
                                                        class="form-control" value="{{ $usuario->rua }}">
                                                    @if ($errors->has('rua'))
                                                        <div class="div-invalid-feedback ">
                                                            {{ $errors->first('rua') }}
                                                        </div>
                                            ...
                                            <div class="col-md-4 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" size="6" name="numero" id="numero"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" size="40" name="bairro" id="bairro"
